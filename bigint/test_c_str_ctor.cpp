...
int main () {
...

    {
        ...
        // Test
        bigint bi("9876589999999999999999886553567999988888884444");

        // Verify
        assert(bi == "9876589999999999999999886553567999988888884444");

        std::cout << "9876589999999999999999886553567999988888884444"<< std::endl;
